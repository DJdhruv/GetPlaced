...
import com.example.dhruv.getplaced.SessionManager;
...
public class StudentLogin extends AppCompatActivity {
     ...
     *
     * contains a login button which vaildates login credentials from our backend
     *
     * contains a button for new user which opens SSO verification portal and redirects to student registration page on successful authorization
     */
    @Override
    ...
    /**
     * This method takes the AUthorization Code as a parameter and makes a post request to https://gymkhana.iitb.ac.in/sso/oauth/token/.
     *
     * The headers are -
     *
     * Request Method : POST
     *
     * Request Property : Host - gymkhana.iitb.ac.in
     *
     * Request Property : Authorization - Basic VTVBanNFVWxiWGREcmNUaWxyWE9tWUFrQXA2aVRFdWx4OXBCclA2eDp3NTNpb25IdEVNa2gyNFZBaHFmTUh0eVU1c3BFc0lMeGFQRElDUGE2Umk3SlQyblhWZzM4Z1VVR0RmWklUVlViWjVmamVkNXBqdjd1ejVJb1M3alFyQlNlbVRTMU1HTlpzZlpMSVdaaTNmVGRHSUlvUmp6ODR0bnFCQ0E0eGhJVg==
     *
     * Request Property : Content-Type - application/x-www-form-urlencoded; charset=UTF-8
     *
     * After the method executes, we get back an Access Token.
     */
    ...
    /**
     * This method takes the Access Token as a parameter and makes a get request to https://gymkhana.iitb.ac.in/sso/oauth/token/.
     *
     * The headers are -
     *
     * Request Method : GET
     ...
     * Request Property : Content-Type - application/x-www-form-urlencoded; charset=UTF-8
     *
     * After the method executes, we get back a JSON which contains the user data.
     */
    ...
    /**
     *  This makes a "POST" request to https://gymkhana.iitb.ac.in/sso/oauth/token/ to revoke the Acess token.
     *
     * The headers are -
     *
     * Request Method : POST
     ...
     * Request Property : Content-Type - application/x-www-form-urlencoded; charset=UTF-8
     *
     * After the method executes, authorization token for user is revoked.
     */
    ...
    /**
     * This method makes a get request to http://ip.address/students/student/?format=json.
     *
     * The headers are -
     *
     * Request Method : GET
     *
     * This gives us the JSON list for students Roll Numbers and Passwords.
     */
