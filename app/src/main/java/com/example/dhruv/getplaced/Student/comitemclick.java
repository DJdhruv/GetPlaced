...
public class comitemclick extends AppCompatActivity {
     ...
     *
     * Displays all the details of the offer with apply button for student to apply for that offer
     */
    @Override
    ...
    /**
     *
     * sends a get method to server and receives details of a particular offer
     */
    public class sendGet extends AsyncTask<String,String,String> {
        ...
        /**
         *
         * Adds the student to list of interested students of that offer if student hasn't already applied
         */
        @Override
    ...
    /**
     *
     * updates Details of the offer with updated list of interested student
     *
     */
