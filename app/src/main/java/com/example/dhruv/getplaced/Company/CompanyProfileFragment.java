...
/**
 *
 * Fragment of CompanyHome Activity to display the profile of company
 */
public class CompanyProfileFragment extends Fragment {
    ...
    /**
     *
     *Displays all the details of the current company
     *
     *send a get request to backend to get details of the company
     */
    ...
    /**
     *
     * Sends a get request to server and receives details of the company in json format
     */
    ...
    public class sendGet extends AsyncTask<String,String,String> {
        ...
        /**
         *
         * converts json string to array and displays the details of the company
          */
        @Override
