...
import com.example.dhruv.getplaced.Resume.ResumeMaker;
...
/**
 * Fragment Activity to display the profile of Student
 */
...
public class StudentProfileFragment extends Fragment {
     ...
     *
     * A logout button which logouts the current user and opens login screen
     *
     * create resume button which open Resume Maker activity
     */
    @Override
