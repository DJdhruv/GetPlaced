...
/**
 *
 * Activity that allow company to add new offer
 */
public class AddOffer extends AppCompatActivity {
     ...
     *
     * generate a form type layout to the company to add basic details of the offer
     *
    ...
    /**
     *
     * update list of offers with the newly added offer
     */
    public class sendGet extends AsyncTask<String,String,String> {
        ...
        /**
         *
         * shows toast on sucessfully update of the offer list
         */
        @Override
