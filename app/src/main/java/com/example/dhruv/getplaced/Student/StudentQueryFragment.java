...
import static com.example.dhruv.getplaced.Student.StudentLogin.USERID;

/**
 *
 * Fragment to display all the query and replies
 */
...
public class StudentQueryFragment extends Fragment {
     ...
     *
     * Displays all the queries and replies to the queries
     *
     * contains a add button which opens a dialog box for user to add new query or to reply someone's query
     */
    @Override
    ...
    /**
     *
     * sends a get request to the server and receives a json string with list of all queries
     */
    public class sendGet extends AsyncTask<String,String,String> {
        ...
        /**
         *
         * json string of queries in a array and provide it to querylistadapter
         */
        @Override
    ...
    /**
     * class to store all the details of a paticular query
     */
    class queritem {
    ...
    /**
     * Converts a  Arraylist of queryitem to a list view
     */
    ...
    /**
     * updates new query to the database
     */
    ...
    public class sendGet1 extends AsyncTask<String,String,String> {
        ...
        /**
         *
         * on Successfully updating a query create a toast of query added
         */
        @Override
        protected void onPostExecute(String result) {
            super.onPostExecute(result);
            Toast.makeText(getActivity(), "Query Added Successfully", Toast.LENGTH_SHORT).show();
